...
public class p011 {
    ...
    public static void main (String[] args) {
        ...
        for (int x = 0; x < 17; x++) {
            for (int y = 0; y < 17; y++) {
                if (diagProdDown(x, y) > max) {
                    max = diagProdDown(x, y);
                }
            }
        }
        for (int x = 3; x < 20; x++) {
            for (int y = 0; y < 17; y++) {
                if (diagProdUp(x, y) > max) {
                    max = diagProdUp(x, y);
                }
            }
        }
     ...
     */
    private static int vertProd(int x, int y) {
     ...
     */
    private static int horiProd(int x, int y) {
     ...
     */
    private static int diagProdDown(int x, int y) {
     ...
     */
    private static int diagProdUp(int x, int y) {
        return grid[x][y]*grid[x-1][y+1]*grid[x-2][y+2]*grid[x-3][y+3];
    }
}
