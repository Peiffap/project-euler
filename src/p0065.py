...
for i in range(35):
    sequence += [1, sequence[-2] + 2, 1] # find the useful terms in the continued fraction

sequence = sequence[:nconv][::-1] # only go up to 100th convergent, and start from the bottom
